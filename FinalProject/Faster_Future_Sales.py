...
# 
# We will load competition data and look closer on it.
# We will try to understand what we have in our hands and 
...
# I can advise downcasting your DataFrame. 
# It will save you some memory, and believe me you will need all memory possible.
# 
# In our case from 134.4+ MB, we went to 61.6+ MB
# 
# Not a great deal right now but such approach works with bigger DF also.
# 
# #### please see this two links for more tips 
# (I stole that downcast basic snippet from anqitu)))
...
# ### Simple graph
# What this graph is telling us. Basically nothing.)) 
# I only see that train data has many old products (degradation line)
# and many 1c products are seasonal and probably release date depended.
# 
...
# In our test set we have 5100 sales in really new shop and 
#no "outdated shops" but anyway it is good feature for future.
...
# 1. Price category (1$/10$/20$/ etc.) - obviously (or not obviously), 
# items with smaller price have greater volumes
...
# With a close look we can find out that some shops have duplicated 
# id/name - probably it changed location (within commercial center), 
# or it has a different type (isle sale point), but I decided to merge it.
# * 11 => 10
# * 1  => 58
# * 0  => 57
# * 40 => 39
